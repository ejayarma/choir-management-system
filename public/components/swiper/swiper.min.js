...
// Virtual Timer Prototype
function VirtualTimer ( opts ) {
...
VirtualTimer.prototype.start = function () {
	this.intervalId = setInterval ( () => {
		this.tick();
	}, this.interval );
};

VirtualTimer.prototype.stop = function () {
	clearTimeout( this.intervalId );
};

VirtualTimer.prototype.reset = function () {
	this.progress = 0;
	if ( this.onTick instanceof Function ) this.onTick.call( this );
};

VirtualTimer.prototype.tick = function () {
