...
<html lang="en">
  ...
  <body>
    <div class="page">
      <!-- Page title-->
      <section class="section page-title bg-image context-dark" style="background-image: url(images/background/bg-5-1920x496.jpg);">
        <!--RD Navbar-->
      ...
      <!-- Search results-->
      <section class="section section-md bg-transparent" data-preset='{"title":"Search Results","category":"service","reload":true,"id":"search-results"}'>
        <div class="container">
          <form class="form-inline group-15" action="search-results.html" method="GET" data-rd-search='{"output":".rd-search-results","mode":"submit"}'>
