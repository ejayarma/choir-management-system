<x-web-layout>
    <x-web.section-one class="intro intro-line context-dark">
                            ...
                            <div class="col-lg-9 col-xl-7 text-center text-lg-left">
                                ...
                                <div class="blurb blurb-link-2">
                                    ...
                                    <div class="blurb-content">
                                        <h4 class="blurb-title"><a href="#">355 S Grand Ave, Los Angeles, CA 90071</a>
                                        </h4>
                                        <div class="blurb-subtitle">Feel free to visit our firm’s office at any time.
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-10 col-lg-7">
                                    ...
                                    <p class="big">Calm Church is a Family of Faith that is committed to Bible teaching
                                        and joyful worship for children, youth and adults of all ages.</p><a
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-10 col-lg-7">
                                    ...
                                    <h1>Connect & Grow</h1>
                                    <p class="big">Our church is a perfect place for all local residents to come in with
                                        their families and join for a prayer and a newfound peace of mind.</p><a
                                        class="btn btn-white" href="#">See More</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-10 col-lg-7">
                                    ...
                                    <p class="big">At our church, we help people to find their way back to God. We
                                        accomplish this by reaching people far from God.</p><a class="btn btn-white"
                                        href="#">See More</a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row row-40 row-xl-55 row-xxl-100 row-offset-md">
                <div class="col-sm-6 col-lg-3" data-animate='{"class":"fadeInUpBig"}'>
                    ...
                    <div class="thumbnail thumbnail-light"><a class="thumbnail-media" href="#"><img
                                src="images/image-18-425x338.jpg" alt="" width="425" height="338" /></a>
                ...
                <div class="col-sm-6 col-lg-3" data-animate='{"class":"fadeInUpBig","delay":".15s"}'>
                    <!-- Thumbnail-->
                    <div class="thumbnail thumbnail-light"><a class="thumbnail-media" href="#"><img
                                src="images/image-12-425x338.jpg" alt="" width="425" height="338" /></a>
                ...
                <div class="col-sm-6 col-lg-3" data-animate='{"class":"fadeInUpBig","delay":".3s"}'>
                    <!-- Thumbnail-->
                    <div class="thumbnail thumbnail-light"><a class="thumbnail-media" href="#"><img
                                src="images/image-1-425x338.jpg" alt="" width="425" height="338" /></a>
                ...
                <div class="col-sm-6 col-lg-3" data-animate='{"class":"fadeInUpBig","delay":".45s"}'>
                    <!-- Thumbnail-->
                    <div class="thumbnail thumbnail-light"><a class="thumbnail-media" href="#"><img
                                src="images/image-8-425x338.jpg" alt="" width="425" height="338" /></a>
            ...
            <div class="container">
                <div class="layout layout-2">
                    ...
                    <div class="layout-content bg-100" data-animate='{"class":"fadeInUpBig","delay":".2s"}'>
                        <h2>About Church</h2>
                        <p>At Calm Church, we want the love that Christ showed on the cross to flow out of our lives,
                            impacting the community.</p>
                        <p>We come from all different backgrounds and cultures but are united in the pursuit and worship
                            of Christ. Above all else, we want to glorify God. We strongly believe that God does His
                            work through the local church and that it is a vital part of the Christian life. Please join
                            us as we come together and let the Gospel transform us!</p>
                        <div class="group-20 mt-5" data-lightgallery><a class="btn btn-primary" href="#">Donate
                                Now</a><a class="btn btn-outline btn-icon lightgallery-item"
            ...
            <div class="row row-5 align-items-center">
                ...
                <div class="col-md-7" data-animate='{"class":"fadeIn","delay":".2s"}'>
                    <p class="big">Explore & listen to the latest seermons by our church’s pastors added daily and
                        available for download in all popular formats.</p>
                </div>
            </div>
            <!-- Swiper slider-->
            ...
            <div class="row row-40 justify-content-between align-items-center">
                <div class="col-md-5" data-animate='{"class":"fadeInLeftBig"}'>
                    <div class="text-block-1">
                        ...
                        <p class="big">Calm Church is a caring, Christian family committed to sharing the love of
                            Christ.</p>
                        <p class="big">To have a better understanding about how we impact the lives of our parishioners,
                            read these recently submitted testimonials.</p><a class="btn btn-outline"
                ...
                <div class="col-md-7 col-xl-6" data-animate='{"class":"fadeInRightBig"}'>
                    <div class="layout layout-3">
                        <div class="layout-media bg-image" style="background-image: url( images/image-16-470x600.jpg )">
                        </div>
                        <div class="layout-content bg-900 context-dark">
                            <div class="owl-carousel owl-quote-3" data-owl="{&quot;dots&quot;:true}" data-items="1">
                                ...
                                <div class="quote quote-line">
                                    <q class="quote-text h4">I first came to this church when visiting my sister. For
                                        me, Calm is an oasis where I can be refreshed with living water. Every Sunday I
                                        come with expectation of what message I will receive from our Lord.</q>
                                    <div class="quote-person"><img class="quote-img"
                                            src="images/person/person-9-53x53.jpg" alt="" width="53" height="53" />
                                ...
                                <!-- Quote icon line-->
                                <div class="quote quote-line">
                                    <q class="quote-text h4">For the first time in many years I have found a place at
                                        Calm Church. It's like coming home again where the people are so warm and
                                        friendly and are genuinely concerned about you.</q>
                                    <div class="quote-person"><img class="quote-img"
                                            src="images/person/person-5-53x53.jpg" alt="" width="53" height="53" />
                                        <cite class="quote-cite"><span class="quote-author">Kate Adams, </span><span
                                                class="quote-position">Parishioner</span></cite>
                                    </div>
                                </div>
                                <!-- Quote icon line-->
                                <div class="quote quote-line">
                                    <q class="quote-text h4">We attended our first Sunday here and we knew right away
                                        there was a uniqueness about this church. God used Calm Church to develop in us
                                        a stronger passion for him and a deeper relationship with him.</q>
                                    <div class="quote-person"><img class="quote-img"
                                            src="images/person/person-10-53x53.jpg" alt="" width="53" height="53" />
                                        <cite class="quote-cite"><span class="quote-author">James Wilson, </span><span
                                                class="quote-position">Parishioner</span></cite>
                                    </div>
                                </div>
                            </div>
                    ...
                    <!-- Person--><a class="person person-poster" href="team-member.html">
                        ...
                        <div class="person-content">
                            <h3 class="person-title"><span>Edward Gray</span><span class="person-meta"> - Care
                                    Pastor</span></h3>
                            <div class="person-text text-decorated text-decorated-3">Edward Gray supports our community
                                groups and helps new parishioners.</div>
                        </div>
                    </a>
                </div>
                <div class="col-sm-6 col-lg-3" data-animate='{"class":"fadeInUpBig","delay":".15s"}'>
                    <!-- Person--><a class="person person-poster" href="team-member.html">
                        ...
                        <div class="person-content">
                            <h3 class="person-title"><span>Kate Lee</span><span class="person-meta"> - Campus
                                    Pastor</span></h3>
                            <div class="person-text text-decorated text-decorated-3">Kate supports our church ministries
                                while also upholding Biblical priorities.</div>
                        </div>
                    </a>
                </div>
                <div class="col-sm-6 col-lg-3" data-animate='{"class":"fadeInUpBig","delay":".3s"}'>
            ...
            <div class="layout layout-2">
                ...
                <div class="layout-content bg-100" data-animate='{"class":"fadeInUpBig","delay":".2s"}'>
                    <div class="text-block-1">
                        ...
                        <p class="big">To stay connected with our church and receive the latest news and updates from
                            us, download the free Calm Church app that offers:</p>
    ...
    <section class="section-sm bg-100 text-center">
        <div class="container">
            <div class="owl-carousel owl-vertical-center owl-content-1" data-owl="{&quot;dots&quot;:true}"
                data-items="2" data-sm-items="3" data-md-items="4"><img src="images/logo/logo-1-157x39.png" alt=""
                    width="157" height="39" /><img src="images/logo/logo-2-95x25.png" alt="" width="95"
                    height="25" /><img src="images/logo/logo-3-92x39.png" alt="" width="92" height="39" /><img
                    src="images/logo/logo-4-116x33.png" alt="" width="116" height="33" />
            </div>
        </div>
    </section>
</x-web-layout>
