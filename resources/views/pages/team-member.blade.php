...
<body>
  <div class="page">
    ...
    <section class="section page-title bg-image context-dark"
      style="background-image: url(images/background/bg-1-1920x496.jpg);">
      <!--RD Navbar-->
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-10 col-xl-8">
            <h2 class="page-title-text">Team member</h2>
            <h4 class="page-title-exeption">Some information about one of our team members</h4>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row row-30 justify-content-center justify-content-sm-between">
          <div class="col-8 col-8 col-md-6 col-lg-5 text-center text-md-left">
            <div class="image-block"><img src="images/person/person-7-469x565.jpg" alt="" width="469" height="565" />
              <div class="image-block-embed">
                <!-- Counter-->
                <div class="counter">
                  <div class="counter-value"><span data-counter="">85</span><span class="counter-unit"></span>
                  </div>
                  <div class="counter-title">Songs</div>
                </div>
              </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="group-5 d-flex flex-wrap align-items-center justify-content-between">
              <h3 class="h3-big">Jane Peters</h3>
              <ul class="list list-inline">
                <li class="list-inline-item"><a class="icon icon-md icon-link-gray mdi mdi-facebook" href="#"></a></li>
                <li class="list-inline-item"><a class="icon icon-md icon-link-gray mdi mdi-youtube-play" href="#"></a>
                </li>
                <li class="list-inline-item"><a class="icon icon-md icon-link-gray mdi mdi-twitter" href="#"></a></li>
              </ul>
            </div>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et
              dolore magna aliqua. Ut enim ad minim veniam sed do eiusmod tempor.</p>
            <div class="address">
              <table>
                <tr>
                  <td class="address-title">Phone:</td>
                  <td class="big"><a class="link link-inherit" href="tel:#">800.567.1234</a></td>
                </tr>
                <tr>
                  <td class="address-title">E-Mail:</td>
                  <td><a class="link link-inherit" href="mailto:#">info@demolink.org</a></td>
                </tr>
                <tr>
                  <td class="address-title">Address:</td>
                  <td>355 S Grand Ave, Los Angeles, CA 90071</td>
                </tr>
              </table>
            </div>
            <div class="row row-content row-5 h4">
              <div class="col-sm-6">
                <ul class="list list-divided list-divided-sm">
                  <li class="list-item">Character</li>
                  <li class="list-item">Christian Life</li>
                  <li class="list-item">Healing</li>
                </ul>
              </div>
              <div class="col-sm-6">
                <ul class="list list-divided list-divided-sm">
                  <li class="list-item">Holy Spirit</li>
                  <li class="list-item">Hope</li>
          ...
          <div class="col-md-11">
            ...
            <div class="quote quote-default quote-default-light quote-default-light">
              ...
              <div class="quote-body">
                <q class="quote-text h3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod ut enim
                  ad minim veniam sed do eiusmod tempor incididunt ut labore et dolore magna aliqua .</q>
                <cite class="quote-cite">James Adams, Parishioner</cite>
              </div>
            </div>
          </div>
          <div class="col-md-12"><a class="btn btn-outline" href="#appointment-form" data-anchor-link>Free
              Consultation</a></div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row row-30 justify-content-between">
          <div class="col-md-6">
            ...
            <p>Ut enim ad minim veniam sed do eiusmod tempor. Sed do eiusmod tempor incididunt ut labore et dolore magna
              aliqua. Ut enim ad minim veniam sed do eiusmod tempor.</p>
          ...
          <div class="col-md-6">
            ...
            <div class="progress-linear">
              <div class="progress-linear-title h4">Public Speaking<span class="progress-linear-counter-wrap"><span
                    class="progress-linear-counter">88</span>%</span>
              </div>
            ...
            <!-- Linear progress bar-->
            <div class="progress-linear">
              <div class="progress-linear-title h4">Spiritual Growth<span class="progress-linear-counter-wrap"><span
                    class="progress-linear-counter">70</span>%</span>
              </div>
              <div class="progress-linear-body">
                <div class="progress-linear-bar"></div>
              </div>
            ...
            <!-- Linear progress bar-->
            <div class="progress-linear">
              <div class="progress-linear-title h4">Counsel<span class="progress-linear-counter-wrap"><span
                    class="progress-linear-counter">74</span>%</span>
              </div>
              <div class="progress-linear-body">
                <div class="progress-linear-bar"></div>
              </div>
            ...
            <!-- Linear progress bar-->
            <div class="progress-linear">
              <div class="progress-linear-title h4">Christian Education<span class="progress-linear-counter-wrap"><span
                    class="progress-linear-counter">68</span>%</span>
              </div>
              <div class="progress-linear-body">
                <div class="progress-linear-bar"></div>
              </div>
    ...
    <section class="section-md bg-900 context-dark" id="appointment-form">
      <div class="container">
        ...
        <form class="rd-mailform rd-form" data-form-output="form-appointment" data-form-type="contact" method="post"
      ...
      <div class="container">
        <div class="row row-5 align-items-center">
          ...
          <div class="col-md-7" data-animate='{"class":"fadeIn","delay":".2s"}'>
            <p class="big">Explore & listen to the latest seermons by our church’s pastors added daily and available for
              download in all popular formats.</p>
          </div>
        </div>
        <!-- Swiper slider-->
            ...
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                ...
                <div class="post post-shadow"><a class="post-media" href="blog-post.html"><img
                      src="images/image-12-370x257.jpg" alt="" width="370" height="257" />
                    <div class="post-hover-btn">View</div>
                  </a>
                  <div class="post-content">
                    <div class="post-tags group-5 text-small"><a class="post-tag" href="songs.html">Songs</a></div>
                    <h4 class="post-title text-divider"><a href="blog-post.html">God’s Cure For the World’s Worst
                        Disease</a></h4>
              ...
              <div class="swiper-slide">
                <!-- Post-->
                <div class="post post-shadow"><a class="post-media" href="blog-post.html"><img
                      src="images/image-1-370x257.jpg" alt="" width="370" height="257" />
                    <div class="post-hover-btn">View</div>
                  </a>
                  <div class="post-content">
                    <div class="post-tags group-5 text-small"><a class="post-tag" href="songs.html">Songs</a></div>
                    <h4 class="post-title text-divider"><a href="blog-post.html">Christian Life: Running Well, Finishing
                        Strong</a></h4>
                    <div class="post-date">November 12, 2021</div>
                  </div>
                </div>
              ...
              <div class="swiper-slide">
                <!-- Post-->
                <div class="post post-shadow"><a class="post-media" href="blog-post.html"><img
                      src="images/image-13-370x257.jpg" alt="" width="370" height="257" />
                    <div class="post-hover-btn">View</div>
                  </a>
                  <div class="post-content">
                    <div class="post-tags group-5 text-small"><a class="post-tag" href="songs.html">Songs</a></div>
                    <h4 class="post-title text-divider"><a href="blog-post.html">The Passing of Religious
                        Opportunity</a></h4>
                    <div class="post-date">November 12, 2021</div>
                  </div>
                </div>
              ...
              <div class="swiper-slide">
                <!-- Post-->
                <div class="post post-shadow"><a class="post-media" href="blog-post.html"><img
                      src="images/image-4-370x257.jpg" alt="" width="370" height="257" />
                    <div class="post-hover-btn">View</div>
                  </a>
                  <div class="post-content">
                    <div class="post-tags group-5 text-small"><a class="post-tag" href="songs.html">Songs</a></div>
                    <h4 class="post-title text-divider"><a href="blog-post.html">Christian Life: Where Are My Strengths?
                        (Romans 12:1-8)</a></h4>
                    <div class="post-date">November 12, 2021</div>
                  </div>
                </div>
              ...
              <div class="swiper-slide">
                <!-- Post-->
                <div class="post post-shadow"><a class="post-media" href="blog-post.html"><img
                      src="images/image-8-370x257.jpg" alt="" width="370" height="257" />
                    <div class="post-hover-btn">View</div>
                  </a>
                  <div class="post-content">
                    <div class="post-tags group-5 text-small"><a class="post-tag" href="songs.html">Songs</a></div>
                    <h4 class="post-title text-divider"><a href="blog-post.html">Life is what Happens to You While You
                        Are Making Plans</a></h4>
                    <div class="post-date">November 12, 2021</div>
                  </div>
                </div>
              </div>
              <div class="swiper-slide">
                <!-- Post-->
                <div class="post post-shadow"><a class="post-media" href="blog-post.html"><img
                      src="images/image-9-370x257.jpg" alt="" width="370" height="257" />
                    <div class="post-hover-btn">View</div>
                  </a>
                  <div class="post-content">
                    <div class="post-tags group-5 text-small"><a class="post-tag" href="songs.html">Songs</a></div>
                    <h4 class="post-title text-divider"><a href="blog-post.html">Rock Solid: How to Build a Life that
                        Lasts</a></h4>
                    <div class="post-date">November 12, 2021</div>
                  </div>
                </div>
